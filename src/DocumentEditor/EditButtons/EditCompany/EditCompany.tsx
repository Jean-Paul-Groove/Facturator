  ...
  return (
    <>
      <Button
        ...
        type="default"
        onClick={() => setCompanyInfoisVisible(true)}
      >
        Vous
      </Button>
      {companyInfoIsVisible && (
        <Modal
          title="Informations de l'entreprise"
          open={companyInfoIsVisible}
          onOk={handleOk}
        ...
        >
          {formIsOpen ? (
            ...
            <div>
              <div className="edit-company-openForm-button">
              ...
              <div>
                ...
                {company.vatNumber && (
                  <>
                    <p className="edit-company-section">Numéro de TVA :</p>{" "}
